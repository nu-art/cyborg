...
public abstract class AutomationStep {
	...
	public AutomationStep(String key) {
		this.key = key;
	...
	public long getIntervalSinceLastAction() {
		return intervalSinceLastAction;
	}

	void setIntervalSinceLastAction(long intervalSinceLastAction) {
		this.intervalSinceLastAction = intervalSinceLastAction;
	}
}
