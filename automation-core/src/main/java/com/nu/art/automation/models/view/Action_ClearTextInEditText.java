...
import static com.nu.art.automation.consts.StepTypes.Type_ClearEditText;

public class Action_ClearTextInEditText
	extends ViewAction {

	public Action_ClearTextInEditText() {
		super(Type_ClearEditText);
	}

	public Action_ClearTextInEditText(String viewId) {
		super(Type_ClearEditText, viewId);
	}
}
