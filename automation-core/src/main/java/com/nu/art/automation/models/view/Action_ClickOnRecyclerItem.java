...
public final class Action_ClickOnRecyclerItem
	extends ViewAction {
	...
	public Action_ClickOnRecyclerItem() {
		super(Type_ClickOnRecyclerItem);
	}

	public Action_ClickOnRecyclerItem(String viewConstantName, int position, ClickType type) {
